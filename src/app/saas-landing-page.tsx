        ...
        <div className={styles.heroContent}>
          <div className={styles.heroLabels}>
            <div className={styles.heroKicker}>
              ...
              نظام تشغيل قانوني متكامل
            </div>
            <div className={styles.heroPriceTag}>
              <strong>1000 ر.س</strong>
              <span>شهريًا لكل المكتب</span>
            </div>
          </div>
          <h1>
            منصة واحدة تدير
          ...
          <p>
            القضايا والموكلون والعقود والمستندات والمالية والفريق في مساحة
            تشغيل عربية واحدة، واضحة من أول يوم.
          </p>
