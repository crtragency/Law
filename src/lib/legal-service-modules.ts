...
export const LEGAL_SERVICE_MODULES: LegalServiceModule[] = [
  ...
  },
  {
    ...
    relatedRoutes: [
      { href: "/contacts", label: "جهات الاتصال" },
      { href: "/clients", label: "الموكلون الحاليون" },
    ],
  },
  {
    slug: "litigation",
    ...
    relatedRoutes: [
      ...
      { href: "/litigation", label: "إجراءات التقاضي" },
  ...
  },
  {
    ...
    relatedRoutes: [
      { href: "/templates", label: "النماذج القانونية" },
  ...
  },
  {
    ...
    relatedRoutes: [
      { href: "/calendar", label: "التقويم" },
      { href: "/reminders", label: "التنبيهات الذكية" },
  ...
  },
  {
    ...
    relatedRoutes: [
      { href: "/reports", label: "التقارير والتحليلات" },
